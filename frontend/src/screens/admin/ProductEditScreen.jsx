          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId='category'>
              ...
              <Form.Select value={category} onChange={(e) => setCategory(e.target.value)}>
                <option value="بدل رجالي">بدل رجالي</option>
                <option value="بلازرات">بلازرات</option>
                <option value="بدل اطفالي">بدل اطفالي</option>
                <option value="أحذية">أحذية</option>
                <option value="أحزمة">أحزمة</option>
            ...
            {/* اختيار المقاسات */}
            {(category==="بدل رجالي"||category==="بناطيل"||category==='بلازرات'||category==="بدل أطفالي") &&  <Form.Group controlId="sizes">
            ...
            {(category === 'بلازرات'||category==="بناطيل"||category==="بدل رجالي") && (
